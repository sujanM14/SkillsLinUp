...
export const getStudent = (student) =>
  ...
  API.post("/api/admin/addclub", club);
// Faculty
...
export const updateassesment = (updatedAssesment) =>
  API.post("/api/student/updateassesment", updatedAssesment);

  export const getSurvey = (survey) =>
  API.post("/api/student/survey", survey);
  // ADD_CLUB_ASSESSMENT
  export const createClubAssessment = (clubassesment) => 
  API.post("/api/student/ClubAssesment", clubassesment);

  export const getclub = () => 
  API.get("/api/student/getclub");

  export const getClubAssesment = (survey) =>
  API.post("/api/student/getClubAssesment", survey);
  // suggestion