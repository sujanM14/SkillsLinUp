...
import AddClub from "./components/admin/AddClub/AddClub";
...
import SoftSkill from "./components/student/softskill/SoftSkill";
...
import Assesment from "./components/student/Assesment/Assesment";
import ClubAssesment from "./components/student/ClubAssesment/ClubAssesment";
import Clubs from "./components/student/Clubs/Clubs";
import Performanceresult from "./components/student/performance/Performanceresult";
import Suggestion from "./components/student/Suggestion/Suggestion";
...
const App = () => {
  return (
    <Routes>
      ...
      <Route path="/student/softskill" element={<SoftSkill />} />
      <Route path="/student/updateassesment" element={<Assesment />} />
      <Route path="/student/survey" element={<Assesment />} />
      <Route path="/student/softskills" element={<SoftSkill />} />
      <Route path="/student/ClubAssesment" element={<ClubAssesment />} />
      <Route path="/student/getClubAssesment" element={<Clubs />} />
      <Route path="/student/performanceresult" element={<Performanceresult />} />
