    ...
    <div className="flex-[0.2]">
      <div className="space-y-8 overflow-y-scroll scrollbar-thin scrollbar-track-white scrollbar-thumb-gray-300 h-[33rem]">
        <div className="">
          ...
          <NavLink
            to="/student/performanceresult"
            className={({ isActive }) =>
              isActive ? isActiveStyle : isNotActiveStyle
            }>
            <AddIcon className="" />
            <h1 className="font-normal">Performance</h1>
          </NavLink>
          <NavLink
            to="/student/updateassesment"
            className={({ isActive }) =>
              isActive ? isActiveStyle : isNotActiveStyle
            }>
            <EngineeringIcon className="" />
            <h1 className="font-normal">Assesment</h1>
          </NavLink>
          <NavLink
            to="/student/ClubAssesment"
            className={({ isActive }) =>
              isActive ? isActiveStyle : isNotActiveStyle
            }>
            <AddIcon className="" />
            <h1 className="font-normal">ClubAssesment</h1>
          </NavLink>
        </div>
        <div className="">
        <NavLink
            to="/student/suggestion"
            className={({ isActive }) =>
              isActive ? isActiveStyle : isNotActiveStyle
            }>
            <MenuBookIcon />
            <h1 className="font-normal">Suggestion here</h1>
          </NavLink>
          <NavLink
          ...
          <NavLink
            to="/student/softskill"
            className={({ isActive }) =>
              isActive ? isActiveStyle : isNotActiveStyle
            }>
           <MenuBookIcon />
            <h1 className="font-normal">Soft Skills</h1>
          </NavLink>     
        
          <NavLink
            to="/student/getClubAssesment"
            className={({ isActive }) =>
              isActive ? isActiveStyle : isNotActiveStyle
            }>
           <MenuBookIcon />
            <h1 className="font-normal">Clubs</h1>
          </NavLink>     
        </div>
        <div className="">
          <NavLink
