  ...
  return (
    <div className="flex-[0.05] flex justify-between items-center mx-5 my-2">
      <div className="flex items-center ">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNhWA369AAo0M_VmX1epi0M848TJID_hC3PNns9DGce5J26fZm&s"
          alt=""
          className="h-7"
        />
        <h1 className="font-bold text-blue-600 text-sm">SkillsLinkUp</h1>
      </div>
